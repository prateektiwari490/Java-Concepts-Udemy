...
public class MapDemo {
	...
	private static void hashMapDemo() {
		...
		// Iterate nested map using entrySet
		System.out.println("Iterating Nested Map using entrySet ...");
		Set<Entry<String, Map<String, Object>>> outerMap = userProfile.entrySet();
		for (Map.Entry<String, Map<String, Object>> outerMapping : outerMap) {
			System.out.println("Name of the User is : " + outerMapping.getKey());
			System.out.println("And the details are : ");
			
			for(Map.Entry<String, Object> innerMapping : outerMapping.getValue().entrySet()) {
				System.out.println(innerMapping.getKey() + " " + innerMapping.getValue());
			}
		}
